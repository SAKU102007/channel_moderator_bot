...
# CHANNEL_ID=-1001234567890 # Укажите ID канала, если это предусмотрено в bot_config.py
...
DB_NAME=channel_moderator_db
```

Никаких кавычек использовать не нужно. 
*Примечание: убедитесь, что база данных с указанным именем (`channel_moderator_db`) создана на вашем сервере PostgreSQL перед запуском бота.*
